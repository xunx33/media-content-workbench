function renderOverview() {
  ...
  html += `<div class="card"><div class="card-title">本月数据总览</div>
    <div class="section-label"><span style="color:#fdba74;">视频平台数据</span><span class="count">${vDone} 条</span></div>
    ...
    <div class="section-label" style="margin-top:10px;"><span style="color:#c4b5fd;">文书平台数据</span><span class="count">${aDone} 条</span></div>
    <div class="stats-grid">
