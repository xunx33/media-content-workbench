function renderOverview() {
  ...
  // 按工作台分区只显示对应类型统计（短视频工作台 / 文书工作台）
  if (workspace === 'video') {
    html += `<div class="section-label"><span style="color:var(--video-orange-light);">视频平台数据</span><span class="count">${vDone} 条</span></div>
    ...
    html += `<div class="section-label"><span style="color:var(--article-purple-light);">文书平台数据</span><span class="count">${aDone} 条</span></div>
    <div class="stats-grid">
