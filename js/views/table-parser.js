function renderTableParser() {
  ...
  // 格式说明（随平台切换）
  html += `<div class="form-group" id="parserHelp" style="font-size:12px;color:var(--text3);line-height:1.7;background:var(--bg-2);border:1px solid var(--border);border-radius:var(--radius-xs);padding:10px 12px;"></div>`;
